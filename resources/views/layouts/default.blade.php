<!-- filepath: /C:/laragon/www/myapp/resources/views/layouts/default.blade.php -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        .background-image {
            background-image: url('{{ asset('images/logo.JPEG') }}'); /* Chemin vers votre image */
...
<body class="bg-gray-300 text-white">
    <div class="background-image">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {{-- Header --}}
            <header class="flex justify-between items-center space-x-5 text-slate-100 py-4">
                {{-- Logo --}}
                <a href="{{ route('index') }}">
                ...
                <form action="{{ route('index') }}" class="hidden md:flex pb-3 pr-2 items-center border-b border-b-slate-300 text-slate-300 focus-within:border-b-slate-900 focus-within:text-slate-900 transition">
                ...
                <nav x-data="{ open: false }" x-cloak class="relative">
                    ...
                    >
                        ...
                        <li>
                            <a href="{{ route('article.create')}}" class="flex items-center px-4 py-2 font-semibold text-sm text-indigo-700 hover:bg-gray-100">
                                Ajouter un article
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-1">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                                </svg>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('article.scanner')}}" class="flex items-center px-4 py-2 font-semibold text-sm text-indigo-700 hover:bg-gray-100">
                                Scanner
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-1">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                                </svg>
                    ...
                    <ul class="hidden md:flex space-x-12 font-semibold">
                        <li><a href="" class="text-indigo-700">Connexion</a></li>
                        <li>
                            <a href="{{ route('article.create')}}" class="flex items-center group text-indigo-700">
                                Ajouter un article
                        ...
                        <li>
                            <a href="{{ route('article.scanner')}}" class="flex items-center group text-indigo-700">
                                Scanner 
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-1 group-hover:ml-2 group-hover:mr-0 transition-all">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                                </svg>
